...
public class US_09_Content extends _Parent {

    public US_09_Content() {
    ...
    @FindBy(xpath = "//div/h3[text()='  Budget Projects ']")
    private WebElement budgetProjectsPage;
    ...
    public WebElement findWebElement(String webElementName) {
        switch (webElementName) {
            ...
            case "deleteYesButton":
                ...
                break;
            case "budgetProjectsPage":
                myElement = budgetProjectsPage;
                break;
            case "searchName":
    ...
    public void findElementsAndSendKeysFromDataTable(DataTable elements) {
        List<List<String>> elementsNameAndValue = elements.asLists(String.class);
    ...
    public void findElementsCheckIfDisabled(String element){
       Assert.assertTrue( findWebElement(element).getAttribute("disabled").equalsIgnoreCase("true"));
    }
